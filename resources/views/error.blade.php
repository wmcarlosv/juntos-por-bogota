...
<div class="container-fluid" id="contenedor">
    ...
    <div class="row">
        <div class="col-md-12 text-center" id="zone-result-friends">
            ...
            <h1>no tienes acceso a realizar esta operación</h1>
        </div>
    </div>

    <div class="row">
        <div class="col-12 text-center">
            <button class="btn btn-primary" onclick="javascript:location.href='/home';" type="button">volver al inicio</button>
        </div>
    </div>
    </div>
</div>
